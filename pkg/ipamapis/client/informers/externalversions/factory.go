...
import (
	...
	fic "github.com/f5devcentral/f5-ipam-controller/pkg/ipamapis/client/informers/externalversions/fic"
...
func (f *sharedInformerFactory) K8s() fic.Interface {
	return fic.New(f, f.namespace, f.tweakListOptions)
}
